...
execSync('git add public/snapshots/ _etl_scripts/customer_overrides.json _etl_scripts/customer_status_overrides.json _etl_scripts/bid_only_customers.json _etl_scripts/churn_subpattern_overrides.json _etl_scripts/stripe_id_overrides.json _etl_scripts/installation_overrides.json _etl_scripts/metric_definitions.json src/data/annual_payer_ids.json src/data/segment_framework.json src/data/cim_narrative.json 2>/dev/null || true', { cwd: ROOT, shell: true });
